...
public class Mover : MonoBehaviour
{
    ...
    protected void Walk(float move)
    {
        _rigidbody.velocity = Vector2.MoveTowards(_rigidbody.velocity, GetTargetSpeed(move), 
            _speedOfChangeOfSpeed * Time.fixedDeltaTime);
    }
